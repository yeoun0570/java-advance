...
public class Book2ComparatorEx {
  ...
  public static void main(String[] args) {
    ...
    //2. DescYear 비교기를 만들어 출판년도를 기준으로 내림차순 정렬
    ...
    //3. 기준1 : 출판년도 최신
    //   기준2 : 출판년도가 같다면 제목의 글자수로 내림차순
    //   기준3 : 출판년도, 제목 글자수가 같다면 제목 내림차순
